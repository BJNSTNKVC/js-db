 ...
 */
const column = (name: string, type: ColumnType, overrides: Partial<ColumnSchema> = {}): ColumnSchema => ({
    name,
    type,
    nullable  : false,
    default   : undefined,
 ...
 */
const table = (columns: ColumnSchema[], overrides: Partial<TableSchema> = {}): TableSchema => ({
    table     : 'users',
    key       : 'id',
    increments: true,
    timestamps: false,
